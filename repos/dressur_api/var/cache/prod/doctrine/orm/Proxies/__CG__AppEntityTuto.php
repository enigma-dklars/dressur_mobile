 ...
 */
class Tuto extends \App\Entity\Tuto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Tuto' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Tuto' . "\0" . 'titre', '' . "\0" . 'App\\Entity\\Tuto' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Tuto' . "\0" . 'url', '' . "\0" . 'App\\Entity\\Tuto' . "\0" . 'activated', '' . "\0" . 'App\\Entity\\Tuto' . "\0" . 'createdAt', '' . "\0" . 'App\\Entity\\Tuto' . "\0" . 'updatedAt'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Tuto $proxy) {
