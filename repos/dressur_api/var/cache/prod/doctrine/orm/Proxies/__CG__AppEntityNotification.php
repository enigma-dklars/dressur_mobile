...
class Notification extends \App\Entity\Notification implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Notification' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Notification' . "\0" . 'user', '' . "\0" . 'App\\Entity\\Notification' . "\0" . 'text', '' . "\0" . 'App\\Entity\\Notification' . "\0" . 'createdAt'];
        }
