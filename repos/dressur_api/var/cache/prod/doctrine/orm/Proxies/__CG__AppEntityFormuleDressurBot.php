 ...
 */
class FormuleDressurBot extends \App\Entity\FormuleDressurBot implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\FormuleDressurBot' . "\0" . 'id', '' . "\0" . 'App\\Entity\\FormuleDressurBot' . "\0" . 'titre', '' . "\0" . 'App\\Entity\\FormuleDressurBot' . "\0" . 'prix', '' . "\0" . 'App\\Entity\\FormuleDressurBot' . "\0" . 'nbrJour', '' . "\0" . 'App\\Entity\\FormuleDressurBot' . "\0" . 'signature', '' . "\0" . 'App\\Entity\\FormuleDressurBot' . "\0" . 'activated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (FormuleDressurBot $proxy) {
