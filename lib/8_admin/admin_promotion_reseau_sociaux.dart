...
class AdminPromotionReseauSociauxListePage extends StatefulWidget {
  @override
  State<AdminPromotionReseauSociauxListePage> createState() =>
      _AdminPromotionReseauSociauxListePageState();
}

class _AdminPromotionReseauSociauxListePageState
    extends State<AdminPromotionReseauSociauxListePage> {
  bool _loading = false;
  ...
  Future<void> fetchPromotionReseauSociaux() async {
    ...
    final url = Uri.parse('$generalRouteForApi/adminListPromoReseau');
