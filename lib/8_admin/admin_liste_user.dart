...
class AdminListeUser extends StatefulWidget {
  @override
  State<AdminListeUser> createState() => _AdminListeUserState();
}

class _AdminListeUserState extends State<AdminListeUser> {
  ...
  Future<void> fetchContactDSs() async {
    ...
    final url = Uri.parse('$generalRouteForApi/adminListeUser');
  ...
  void _filterContacts() {
    if (_searchText.isEmpty) {
      setState(() {
        ...
        nombreUsers = _filteredContacts.length;
      });
    } else {
      final filteredList = _contacts
          .where((contact) =>
              contact.id.toLowerCase().contains(_searchText.toLowerCase()) ||
              contact.pseudo
                  .toLowerCase()
