...
Future<void> initUserInformations(userInfos) async {
  ...
  fraisAdhesionVendeur =
      (userInfos["fraisAdhesionVendeur"] as num?)?.toInt() ?? 2000;
  montantRechargeInitialeDeveloppeur =
      (userInfos["montantRechargeInitialeDeveloppeur"] as num?)?.toInt() ?? 0;
