           ...
           DelayedAnimation(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                border: const OutlineInputBorder(),
                errorText: _isValidLink ? null : "Veuillez saisir un lien valide.", // Set error text if link is invalid
              ),
              onChanged: (text) {
                setState(() {
          ...
          DelayedAnimation(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: Text(
                  _desactive3 ? (langUserPhone == "fr") ? "Patientez ..." : "Wait ..." : (langUserPhone == "fr") ? "Payer et Démarrer" : "Pay and Get Started",
                  style: GoogleFonts.poppins(
                    color: Colors.white,
                  ),
                ),
