              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      (langUserPhone == "fr")
                          ? "NB: Les Boosts Gratuit sont beaucoup plus mis en avant! Il est donc conseillé de faire des Boosts Gratuit plutôt que Payant. Il n'est pas possible de connaitre à l'avance le nombre de contacts après boost ni la tranche rapproché. Vous pouvez programmer plusieurs Boosts Gratuit contrairement au Payant. Parrainé des utilisateurs pour avoir des bonus et ainsi faire des Boosts Gratuit. Votre Boost Contact Devient Inactif si votre dernière connexion remonte à plus de 48H. Connectez-vous donc au minimum une fois par jour pour récupérer les contacts obtenus."
                          : "NB: The Free Boosts are much more highlighted! It is therefore advisable to make Boosts Free rather than Paid. It is not possible to know in advance the number of contacts after boost nor the close range. You can schedule several Free Boosts unlike the Paid. Sponsored users to have bonuses and thus make Free Boosts. Your Contact Boost becomes inactive if your last connection is more than 48 hours old. So connect at least once a day to retrieve the contacts obtained.",
                      style: GoogleFonts.poppins(
