...
class CampagneMailListePage extends StatefulWidget {
  @override
  _CampagneMailListePageState createState() => _CampagneMailListePageState();
}

class _CampagneMailListePageState extends State<CampagneMailListePage> {
  bool _loading = false;
